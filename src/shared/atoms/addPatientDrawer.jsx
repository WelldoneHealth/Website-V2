...
const AddPatientDrawer = ({
  ...
  const validateForm = () => {
    ...
    if (!formData.patientName)
      formErrors.patientName = "First Name is required";
    ...
    if (
      formData.pincode &&
      (isNaN(formData.pincode) || formData.pincode.length !== 6)
    )
      formErrors.pincode = "Pin Code must be a valid Number";
      ...
      <Drawer className open={isOpen} onClose={onClose}>
        <DrawerContent className="overflow-y-scroll w-full  msm:w-[490px]  overflow-x-hidden ">
          ...
          <DrawerHeader className="mt-16 relative flex flex-col gap-y-2 items-center">
            ...
            <div
              onClick={onClose}
              className="absolute left-5 top-3 flex lsm:hidden cursor-pointer"
            >
          ...
          <div
            ...
            className="w-full px-5 space-y-2 h-[calc(100vh-210px)] overflow-y-scroll"
          >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full h-[45px] border rounded-md px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors.patientName ? "border-red-600" : ""
                }`}
                required
              />
              {errors.patientName && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full h-[45px] border rounded-md px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                  errors.mobileNumber ? "border-red-600" : ""
                }`}
                required
              />
              {errors.mobileNumber && (
            ...
            <div className="w-full">
              ...
              {errors.relationship && (
                <p className="text-red-600 text-sm">{errors.relationship}</p>
              )}
            </div>
          </div>
