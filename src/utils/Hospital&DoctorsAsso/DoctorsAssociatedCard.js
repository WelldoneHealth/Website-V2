...
export default function DoctorsAssociatedCard({ cardDetails }) {
  return (
    <div
      ...
      className=" my-1  mx-auto sm:mx-2  flex-none h-full max-w-[430px] flex flex-col  justify-between  rounded-[20px] px-2 asm:px-4  pb-3 ssm:pb-4 pt-3 ssm:pt-[6px]   "
    >
      <div className="mb-2 asm:mb-4 w-full ssm:space-y-2  flex flex-col ssm:flex-row justify-center items-center   gap-x-4 ">
        ...
        <div className="w-[130px] bg-[#EFF8FF]  flex justify-center  items-center ssm:w-[95px]   md:w-[28%] lg:w-[33%] esm:w-[100px] relative rounded-full aspect-[1/1] overflow-hidden ">
          <img
            src={
              cardDetails?.profile_picture
                ? cardDetails?.profile_picture
...
{/* --------------details portion------------------ */}
        <div className="w-full ssm:w-[60%] h-full   asm:w-[70%] max-w-[600px]  max-ssm:space-y-2  ssm:gap-y-1 mb-3 asm:my-0 flex flex-col items-center  ssm:items-start  ">
          {/* ---------------rating---------- */}
          <div className=" mt-5 ssm:mt-0  mb-1 text-xs font-medium  bg-[#EFF8FF] text-[#01549A] px-2 asm:px-3 py-[6px]  rounded-[20px] hidden items-center ">
          ...
          {/* --------------------name------------------ */}
          <p className="font-medium text-base sm:text-sm md:text-base lg:text-sm esm:text-base leading-tight text-center ssm:text-left capitalize">
          ...
          {/* ---------------hiospital------------- */}
          <p className="text-sm sm:text-xs md:text-sm lg:text-xs esm:text-sm mt-1  flex items-center gap-x-1 capitalize">
