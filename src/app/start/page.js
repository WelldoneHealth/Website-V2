  ...
  return (
    <div className="w-full  relative  mx-auto  max-w-[1600px]  space-y-16     pt-[1px]   lg:px-0  ">
      <div
        style={{
          background:
            "linear-gradient(258.83deg, #FFFFFF 39.07%, #EBF6FF 99.2%)",
        }}
      ...
      >
        <div className="space-y-12 asm:space-y-16 md:space-y-10 max-md:order-2 pt-2 md:pt-16 max-md:pb-10">
          <p className="text-primary font-semibold text-[21px] asm:text-[25px]  msm:text-[35px] md:text-[32px] lsm:text-[36px] lg:text-[40px] 2xl:text-[42px] leading-tight">
            Start your Clinical practice journey at Welldonehealth.in
          </p>
          <Link
        ...
        <div className="max-md:order-1 max-md:w-[70%] ">
          <img
            src={header4?.src}
            className="w-full max-md:mx-auto block"
            alt="load..."
          />
        </div>
      </div>
        ...
        <div className="w-full flex   space-y-8">
          ...
          <div className="flex-1 max-lg:hidden     ">
            <div className=" w-full sticky top-[70px]  space-y-2 ">
              <div
                type="button"
                className="max-xl:w-[95%] text-base xl:text-lg  xl:px-10    py-2 rounded-lg  font-semibold border-[2px] border-primary text-primary"
              >
                Requirements to Practice
              </div>
              <button
                type="button"
                onClick={() => scrollToViewArea(0)}
                className="max-xl:w-[95%] text-base   xl:px-10  py-2"
              >
                Create Professional Profile
              </button>
              <button
                type="button"
                onClick={() => scrollToViewArea(1)}
                className="max-xl:w-[95%] text-base text-nowrap px-10  py-2"
              >
                Consultation & Prescription
              </button>
              <button
                type="button"
                onClick={() => scrollToViewArea(2)}
                className="max-xl:w-[95%] text-base px-10  py-2"
              >
                Receive fee & payments
              </button>
              <button
                type="button"
                onClick={() => scrollToViewArea(3)}
                className="max-xl:w-[95%] text-base px-10  py-2"
              >
                Tools to grow
              </button>
