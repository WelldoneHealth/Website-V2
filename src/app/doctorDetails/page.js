...
const educationalData=[
  ...
  return (
   ...
   <div className="w-full  mt-8 flex justify-between items-start gap-x-7">
<div className=" w-[68%]  ">
...
<div className="flex gap-x-3">
    <div className="border-2 rounded-md text-base font-medium px-2 py-[2px] border-[#E8E8E8]  text-[#72DACB]">Haematology</div>
    <div className="bg-[#023C77] rounded-md text-base font-medium  flex justify-center items-center min-w-[100px] text-white">(124)</div>
</div>
<h3 className= 'my-3  text-[#023C77] font-semibold text-[26px] '>Dr. Roksana Rahman</h3>
...
<p className='w-[95%] text-[#A7A7A7] font-normal text-base leading-relaxed ' >Nullam posuere arcu in nisi gravida commodo a sit amet dolor. Quisque imperdiet nisl sed ante ultrices auctor. Nulla odio lacus, auctor sed tortor in, auctor imperdiet erat. Cras dignissim quis metus nec accumsan.</p>
    ...
    <div className="">
            <div className="">
                ...
                <div className="">
                    ...
                    <p className='text-[#0C447C] text-[22px] font-semibold'>+99 00 555 222 33</p>
                </div>
    </div>
    <div className="mx-2 flex gap-x-2">
        {/* --icons- */}
        <div className="w-8 h-8 rounded-full cursor-pointer hover:bg-[#59D3C2] bg-[#F2F5F8]"></div>
        <div className="w-8 h-8 rounded-full cursor-pointer hover:bg-[#59D3C2] bg-[#F2F5F8]"></div>
        <div className="w-8 h-8 rounded-full cursor-pointer hover:bg-[#59D3C2] bg-[#F2F5F8]"></div>
    </div>
</div>
...
<div className="w-full my-9">
    <h3 className=' my-3 text-2xl text-[#184D83] font-semibold'>About Me</h3>
    ...
    <div className="flex gap-x-4 mt-8">
        {[certificateImage1,certificateImage2,certificateImage3,certificateImage4].map((item,index)=><div key={index} className="w-1/4">
...
<div className="w-full my-5">
    <h3 className=' my-3 text-2xl text-[#184D83] font-semibold'>Specialities</h3>
    <div className=" ">
      ...
      <div className="">
        {/* ------speciality boxes-------- */}
        {["Obstetrics & Gynecology","Dermatology","General Dentistry"].map((item,index,arrLen)=><div key={index} className={`my-4 w-[70%]     flex gap-x-14 items-center   ${index!==(arrLen.length-1) && " border-b-[1px] border-[#E5EBF1]"}`}>
            <div className=" my-7  flex flex-col gap-y-5 ">
                <h5 className='text-[#184D83] text-base font-semibold'>{item}</h5>
            ...
            <div className="rounded-full p-6 bg-[#F2F5F8] border-l-[12px] border-[#E5EBF1]">
...
<div className="w-full my-7">
    <h3 className=' my-3 text-2xl text-[#184D83] font-semibold'>Education</h3>
    <div className="space-y-7 mb-6 ">
        <p className='text-base font-normal text-[#A7A7A7] '>Integer sit amet magna fringilla, consequat odio ac, varius tellus. Etiam eget varius dolor, et sodales quam. Mauris ut sapien diam. Nam imperdiet fringilla dui, id varius purus ultricies eget. Aliquam venenatis, est ac porttitor finibus, lectus magna semper diam, eu cursus mi diam posuere erat.</p>
        <p className='text-base font-normal text-[#A7A7A7]'>Cras blandit mauris leo. Sed sagittis id felis eu viverra. Nulla non ligula a sapien laoreet accumsan. Morbi egestas tincid unt tellus sed vulputate. Praesent fringilla, ex quis vulputate accumsan, nibh elit porttitor diam, sed vehicula mi lacus et magna. Mauris fringilla massa nec nisl facilisis bibendum. Mauris eu felis odio</p>
    </div>
   <div className="my-14 w-full flex flex-wrap gap-y-6">
    {/* -----------education cards------------ */}
   {educationalData.map((item,index)=><div key={index} className="w-1/2 flex items-center gap-x-2">
        <div className="bg-[#59D3C2] w-16 h-16 flexCenter rounded-full">
        ...
        <div className="">
            <p className='text-[#0C447C] text-xl font-semibold'>{item?.eduType}</p>
...
<div className="flex-1 w-[90%] min-h-[800px] bg-[#F2F5F8] rounded-md px-7 py-5 ">
<p className='text-[26px] font-medium text-[#023C77]'>Doctor Visit <span className='text-[#59D3C2]'>$20</span></p>
...
<div className="my-5 space-y-6 w-full">
    <div className="w-full rounded-md bg-white flex gap-x-3 px-7 py-5">
        <img src={clockIcon?.src} className='w-4'  /><input type="text" className='' placeholder='dd-mm-yyyy'  />
    </div> 
    <div className="w-full rounded-md bg-white flex gap-x-3 px-7 py-5">
        <img src={clockIcon?.src} className='w-4'  /><input type="text" className='' placeholder='08:00 AM'  />
    </div> 
    <div className="w-full rounded-md bg-white flex gap-x-3 px-7 py-5">
        <img src={clockIcon?.src} className='w-4'  /><input type="text" className='' placeholder='Patient Name'  />
    </div> 
<button type="button" className='w-full flexCenter  rounded-md bg-[#59D3C2] px-7 py-5'  >Book Appointement</button>
</div>
{/* <div className="">
    <h6>Select Service</h6>
    <div className="flex gap-x-5">
        <div className="px-3  text-sm flexCenter border-[1px] border-[#898989]">Consult</div>
        <div className="p-2">Consult</div>
        <div className="p-2">Consult</div>
    </div>
</div> */}
</div>
