...
export default function page() {
  ...
  return (
   <div className="w-full max-w-[1600px] mx-auto px-1 pt-[1px]  asm:px-3 lg:px-0   gap-x-2 ">
...
<div className="w-full lsm:hidden my-3 mb-5 flex bg-green-900 justify-between gap-x-16 text-[13px]  sm:text-sm" >
 ...
 {view===1 && <div className="flex ">
       {/* ---------1st part--------- */}
       <div className= " max-lsm:hidden w-[200px] xl:w-[300px] h-screen  px-2 py-3 space-y-2 ">
...
<div className="flex p-2 rounded-[10px]  gap-x-3 border-[1px] border-[#01549A]">
    <div className="max-xl:hidden text-white size-12 flexCenter bg-primary rounded-full">RN</div>
...
<button className='xl:hidden text-[#01549A] font-medium px-4 py-2 rounded-[10px] border-[1px] border-[#01549A] text-sm xl:text-base '>+ Family Member's</button>
    ...
    {/* --------2nd part------------- */}
    <div className=" max-md:w-full bg-red-800 flex-1 md:border-l-[1px] border-[#545454] h-screen overflow-y-scroll custom-scrollbar">
...
<div className="px-5  py-2 pb-7 w-full space-y-3  border-b-[1px] border-[#545454]  min-h-screen ">
    ...
    <div style={{boxShadow:" 1px 1px 4px 2px #8383834D"}} className="w-full  space-y-3 bg-yellow-800 sm:px-5 py-4 rounded-[15px] sm:border-[0.5px] border-[#DADADA]">
  {/* --------------cards text---------- */}
     <div className="w-full max-sm:hidden flex  items-start gap-x-16 xl:justify-between   text-[11.6px] md:text-sm ">
            {/* -------writing 1 st part------- */}
            <div className="font-normal">
<p><span className='font-semibold'>Patient-</span> Rakesh Nandre</p>
<p><span className='font-semibold' >Appointment id-</span> 123456789​</p>
<p><span className='font-semibold'>Total-</span> ₹ 700.00</p>
            </div>
            {/* ------------writing 2 nd part-------------- */}
            ...
            {/* ---------------writing 3 rd part----------- */}
            <button className='max-xl:hidden text-[#01549A] font-medium px-2 md:px-4 py-1 rounded-[10px] border-[1px] border-[#01549A] text-[11px] md:text-sm flex justify-center items-center text-nowrap '> + Show Appointment details</button>
        </div>

     {/* -----------main appointement section-------- */}
     <div className="w-full bg-green-900   p-4 border-[1px] border-[#DADADA] rounded-[15px]">
      
<div className=" w-full   max-md:text-sm bg-[#F3FFEE] rounded-[5px] text-[#01A400] py-2 px-[34px] text-sm flex items-center   ">
...
<div className="">
<div className="w-full mt-4 flex gap-x-7 ">
  {/* ----inside old appointment card 1 st part-------- */}
  {/* <div className="flex gap-x-8"> */}

  {/* -----------1st part------------- */}
    <div className="   overflow-hidden  rounded-full">
        <img src={doctorAppointmentImage2?.src} className='w-[120px] sm:w-[180px] md:w-[205px]  ' alt="load..."  />
    </div>
{/* ---------2nd part-------------- */}
    <div className=" w-full  ">

    <div className="w-full flex   gap-y-3 justify-between  max-md:flex-wrap ">
    <div className=" space-y-1 text-nowrap   md:space-y-2">
       <p className='text-lg md:text-[20px] font-medium'>Dr. Aradhana Bhamare</p>
        <p className='text-xs md:text-sm'>Cardiologist Surgery, General Surgeon</p>
        <p className='text-[13px] md:text-sm'>Shidhivinayak Hospital - Dhule</p>
        <p className='text-[13px] sm:hidden md:text-sm'>Book for Rakesh Nandre (Self)</p>
       </div>
 <div className="   max-xl:hidden bg-red-900  max-xl:flex flex-col  items-center gap-x-5  xl:space-y-3 ">
<button type="button" className='px-5 py-[6px] flex-1 md:w-[250px] flex items-center gap-x-2 text-sm font-medium border-[1px] border-[#01549A]  rounded-[20px] text-[#01549A]  text-center'> <img src={rxNoteIcon?.src} className='w-[12px]' alt="load..."  />  Prescription2 </button>
<button type="button" className='px-5 py-[6px] flex-1 md:w-[250px] flex items-center gap-x-2 text-sm font-medium border-[1px] border-[#01549A]  rounded-[20px] text-[#01549A]  text-center'> <img src={rxNoteIcon?.src} className='w-[12px]' alt="load..."  />  Prescription </button>
</div>
...
<div style={{boxShadow:" 1px 1px 4px 2px #8383834D"}} className="w-full  space-y-3  sm:px-5 py-4 rounded-[15px] sm:border-[0.5px] border-[#DADADA]">
  {/* --------------cards text---------- */}
     <div className="w-full max-sm:hidden flex  items-start gap-x-16   text-[11.6px] md:text-sm">
            {/* -------writing 1 st part------- */}
            <div className="font-normal">
<p><span className='font-semibold'>Patient-</span> Rakesh Nandre, (Me)</p>
<p><span className='font-semibold' >Appointment id-</span> 123456789​</p>
...
<div className="w-full max-sm:hidden  bg-[#FFF0F0] rounded-[5px] text-[#F10000] py-[10px] px-[34px] text-sm flex items-center   ">
...
<div className="w-full sm:hidden bg-[#FFF0F0] rounded-[5px] text-[#F10000] py-[10px] px-[34px] text-sm flex items-center   ">
    <img src={crossIcon?.src}  className='w-4 mr-2'  alt="load..."  /> Cancelled on  &nbsp;<span className='font-semibold'> Thursday 05 Sep, 2024</span>
</div>
...
<button type="button" className='px-5 py-[6px] w-[250px] justify-center flex items-center gap-x-2 text-sm font-medium border-[1px] border-[#01549A]  rounded-[20px] text-white bg-primary  '>  Book Again </button>
    ...
    <div className="max-md:hidden mt-4 w-full space-y-2">
        <div className='max-w-max py-1 px-5 bg-[#F0F8FF] text-sm text-[#01549A] italic rounded-[15px]'>Share by Welldone Health Doctor/Clinic/Hospital this appointment with you.</div> 
</div>
